...
class Ui_MChat_window(object):
    def setupUi(self, MChat_window):
        ...
        self.verticalLayout_3.addWidget(self.l_invia_messaggio)
    ...
    def retranslateUi(self, MChat_window):
        ...
        self.actionSplash_window.setToolTip(_translate("MChat_window", "Activate/Deactivate splash window when a new message was received (F4 shortcut key)"))
